...
| :---- | :---- |
| **Protocol Number** | 20210401 |
| **Sponsor** | FloodLAMP Biotechnologies, PBC |
| **Investigational Products** | FloodLAMP QuickColorTM Test, FloodLAMP QuickFluorTM Test, FloodLAMP EasyPCRTM Test, FloodLAMP Home Collection Kit |
...
| **Primary Objective** | The objective of this study is to generate clinical performance and usability data for the FloodLAMP QuickColorTM, QuickFluorTM, and EasyPCRTM Tests and FloodLAMP Home Collection Kit. |
...
FloodLAMP QuickColorTM COVID-19 Test and FloodLAMP QuickFluorTM COVID-19 Test are reverse transcriptase loop-mediated isothermal amplification (RT-LAMP) assay. The FloodLAMP EasyPCRTM COVID-19 Test is a real-time reverse transcriptase polymerase chain reaction (RT-qPCR) assay. The tests are intended for the qualitative detection of RNA from SARS-CoV-2 in upper respiratory specimens including nasopharyngeal swabs, anterior nasal and mid-turbinate nasal swabs from individuals suspected of COVID-19 by their healthcare provider and from individuals without symptoms or other epidemiological reasons to suspect COVID-19 infection, when tested at a weekly interval with no more than 9 days between tests. Testing is limited to laboratories certified under the Clinical Laboratory Improvement Amendments of 1988 (CLIA), 42 U.S.C. §263a, to perform high complexity tests, or by similarly qualified non-U.S. laboratories. 
...
The objective of this study is to generate clinical performance data for the FloodLAMP QuickColorTM COVID-19 Test, FloodLAMP QuickFluorTM COVID-19 Test, FloodLAMP EasyPCRTM COVID-19 Test, and the FloodLAMP Home Collection Kit. 
...
1. ## INVESTIGATIONAL USE ONLY KIT CONFIGURATION

See Instructions for Use: Materials Provided but Not Required

2. ## REAGENTS, CONSUMABLES AND EQUIPMENT REQUIRED BUT NOT PROVIDED
...
7. **STUDY PROCEDURE**
   ...
   1. ## BLINDING OF THE STUDY AND PROCEDURES TO MINIMIZE BIAS
...
5. Testing personnel will not have access to any prior clinical data or reference method (comparator) results.
   ...
   2. ## SAMPLE TYPES, SAMPLE COLLECTION, PROCESSING AND STORAGE
...
2. ## DOCUMENTING AND HANDLING OF DEVIATIONS FROM THE PROTOCOL
...
7. ## STUDY COMPLETION AND CLOSE OUT
...
11. **RISK ANALYSIS**
    ...
    1. ## CLINICAL STUDY SITES AND INFORMED CONSENT 
...
14. **ASSOCIATED DOCUMENTS**
    ...
    1. ## Instructions for Use FloodLAMP QuickColorTM COVID-19 Test v1.0

    2. Instructions for Use FloodLAMP QuickFluorTM COVID-19 Test v1.0

    3. Instructions for Use FloodLAMP EasyPCRTM COVID-19 Test v1.0

    4. Instructions for Use FloodLAMP Home Collection Kit 

    5. Research Subject Information and Consent Form
