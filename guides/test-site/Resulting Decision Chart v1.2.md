...
# Resulting Decision Chart v1.2
**Document Number:** 
**Effective Date:** 
**Version:** 1.2

## Resulting decision chart (double triplicate rerun)
Version 1.2
...
## Resulting decision chart (single triplicate rerun)
Version 1.2
